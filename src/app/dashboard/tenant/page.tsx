      ...
      <div className="bg-white border border-slate-100 rounded-3xl p-8 shadow-[0_10px_40px_-10px_rgba(0,0,0,0.03)] flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <div className="flex items-center gap-2 mb-2">
            <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold bg-violet-50 text-[#B4A0FF] border border-violet-100">
              Tenant Account
            </span>
          </div>
          ...
          <p className="text-sm text-gray-500 mt-1 font-medium">
            Find compatible roommates and rental options in your preferred area.
          </p>
        </div>
        <button
      ...
      <div className="bg-white border border-slate-100 rounded-3xl p-8 shadow-[0_10px_40px_-10px_rgba(0,0,0,0.03)]">
        ...
        <div className="space-y-6 max-w-2xl">
          <div className="flex items-center gap-4 border-b border-gray-50 pb-4">
            <div className="w-10 h-10 rounded-xl bg-violet-50 flex items-center justify-center text-[#B4A0FF] flex-shrink-0">
          ...
          <div className="flex items-center gap-4 pb-2">
            ...
            <div>
              <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider">Account ID</p>
